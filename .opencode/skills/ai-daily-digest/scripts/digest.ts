...
Environment:
  DEEPSEEK_API_KEY  Required. Get one at https://platform.deepseek.com/api_keys
...
async function main(): Promise<void> {
  ...
  if (!apiKey) {
    console.error('[digest] Error: DEEPSEEK_API_KEY environment variable is required.');
    console.error('[digest] Get one at: https://platform.deepseek.com/api_keys');
    process.exit(1);
  }
